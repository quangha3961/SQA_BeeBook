...
public class PromotionServiceUpdateTest {
    ...
    public void testUpdatePromotion_Fail_NameTooShort() {
        ...
        // Bổ sung kiểm tra DB
        Promotion promotionFromDb = entityManager.find(Promotion.class, savedPromotion.getId());
        assertNotNull(promotionFromDb, "Chương trình khuyến mãi vẫn tồn tại trong DB sau khi cập nhật tên quá ngắn.");
    }
    ...
    public void testUpdatePromotion_Fail_NullFields() {
        ...
        // Bổ sung kiểm tra DB
        Promotion promotionFromDb = entityManager.find(Promotion.class, savedPromotion.getId());
        assertNotNull(promotionFromDb, "Chương trình khuyến mãi vẫn tồn tại trong DB sau khi cập nhật các trường null.");
