...
public class ContactServiceSearchTest {
    ...
    // Test: Tìm liên hệ với searchModel.keyword = null
    @Test
    @Order(6)
    @Transactional
    @Rollback
    public void testSearchWithNullKeyword() {
        // First, create a contact to ensure the table is not empty
        Contact contact = new Contact();
        contact.setName("Nguyen Van B");
        contact.setEmail("nguyenvanb@example.com");
        contact.setMassage("Another test message");
        contactService.saveOrUpdate(contact);
    ...
    // Test: Tìm liên hệ với searchModel.keyword = "" (rỗng)
    @Test
    @Order(7)
    @Transactional
    @Rollback
    public void testSearchWithEmptyKeyword() {
        // First, create a contact to ensure the table is not empty
        Contact contact = new Contact();
        contact.setName("Nguyen Van C");
        contact.setEmail("nguyenvanc@example.com");
        contact.setMassage("Empty keyword message");
        contactService.saveOrUpdate(contact);
