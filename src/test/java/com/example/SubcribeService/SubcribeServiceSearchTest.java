...
public class SubcribeServiceSearchTest {
    ...
    // Add 1: Tìm đăng ký với searchModel.keyword = null
    @Test
    @Order(5)
    @Transactional
    @Rollback
    public void testSearchWithNullKeyword() {
        Subcribe subcribe = new Subcribe();
        subcribe.setEmail("user4@example.com");
        subcribe.setCreatedDate(new Date());
        subcribeService.saveOrUpdate(subcribe);
    ...
    // Add 2: Tìm đăng ký với searchModel.keyword = "" (rỗng)
    @Test
    @Order(6)
    @Transactional
    @Rollback
    public void testSearchWithEmptyKeyword() {
        Subcribe subcribe = new Subcribe();
        subcribe.setEmail("user5@example.com");
        subcribe.setCreatedDate(new Date());
        subcribeService.saveOrUpdate(subcribe);
